...
// { theme: { mode: "dark", colors: { primary: "#ff6600", secondary: "#666" } },
//   layout: "grid", fontSize: 14 }
```

## Examples

### Example 1: Pattern Matching Simulation
...
const result = match(status, [
    [200, "OK"],
    [404, "Not Found"],
    [v => v >= 500, "Server Error"],
    [v => v >= 400, "Client Error"]
]);
```
