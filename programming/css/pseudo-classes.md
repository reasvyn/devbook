...
### Custom Checkbox with Pseudo-Elements
...
### Zebra-Striped Table with :nth-child
...
/* Three-column stripe pattern */
tbody tr:nth-child(3n+1) { background: #f8f9fa; }
tbody tr:nth-child(3n+2) { background: #f0f4ff; }
tbody tr:nth-child(3n) { background: #fff3cd; }
```

## Examples

### Example 1: Tooltip with ::before
...
### Example 2: Drop cap with ::first-letter
