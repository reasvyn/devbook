...
Foundations every developer needs — logic, discrete math, linear algebra, calculus, and statistics.

- [Why Math Matters](intro/why-math.md)
- [The Mathematical Mindset](intro/the-mathematical-mindset.md)
- [Logic for Developers](intro/logic-for-developers.md)
