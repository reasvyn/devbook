...
- [Source Coding Theorem](source-coding.md) — lossless compression, Kraft inequality, Huffman coding, arithmetic coding
- [Channel Capacity](channel-capacity.md) — discrete channels, symmetric channels, capacity theorem
- [Rate-Distortion Theory](rate-distortion.md) — lossy compression, rate-distortion function
- [Error-Correcting Codes](error-correcting-codes.md) — Hamming codes, Reed-Solomon, LDPC, turbo codes