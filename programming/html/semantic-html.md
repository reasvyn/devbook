...
**Case 1: The div soup that breaks screen reader navigation.**

A developer's page is built entirely out of `<div>` elements with CSS classes. Screen reader users cannot jump to the main content, navigate by headings, or find the navigation. Every element sounds like "Generic landmark" or nothing at all.

The fix: replace `<div>` with semantic elements:
...
**Case 2: The heading levels that jump from h1 to h4.**

A developer uses `<h1>` for the site title, then `<h4>` for the section title (because they think h4 looks better):
...
Screen reader users who navigate by headings hear "Heading level 1, heading level 4, heading level 4" and wonder if the page has content between levels 1 and 4.

The fix: use sequential heading levels:
...
**Case 3: The article without a heading.**

A developer uses `<article>` for a product listing but forgets to include a heading:
...
Screen readers announce "Article" but cannot determine the topic of the article. The implicit `region` role requires a heading for proper identification.

The fix: add a heading:
...
**Example 1: Blog post with full semantic structure.**
...
<head>
    ...
    <title>Understanding Semantic HTML — DevBook</title>
</head>
<body>
    <header>
        <nav aria-label="Main">
            <a href="/" aria-label="Home">
                <img src="logo.svg" alt="DevBook" width="150" height="40">
            </a>
            <ul>
    ...
    <main>
        <article>
            <header>
                ...
                <p>
                    Published <time datetime="2026-06-28">June 28, 2026</time>
                    by <a href="/authors/alice">Alice Johnson</a>
                </p>
            </header>

            <p>Semantic HTML is the practice of using HTML elements that convey meaning about the structure and content of a web page.</p>
            ...
            <section>
                ...
                <aside>
                    <h3>Quick Fact</h3>
                    <p>The HTML5 specification introduced several new semantic elements, including <code>&lt;article&gt;</code>, <code>&lt;section&gt;</code>, <code>&lt;nav&gt;</code>, and <code>&lt;aside&gt;</code>.</p>
                </aside>
            </section>
            ...
            <section>
                ...
                <dl>
                    ...
                    <dd>Introductory content for a page or section.</dd>
                    <dt><code>&lt;nav&gt;</code></dt>
                    <dd>Navigation links.</dd>
                    <dt><code>&lt;main&gt;</code></dt>
                    <dd>The primary content of the page.</dd>
                </dl>
            </section>
        </article>
        ...
        <aside>
            ...
            <ul>
                ...
                <li><a href="/html/document-structure">Document Structure</a></li>
            </ul>
        </aside>
    </main>
...
**Example 2: Product listing with semantic elements.**
...
<main>
    ...
    <section aria-labelledby="results-heading">
        <h2 id="results-heading">Products (24 results)</h2>

        <article>
            <h3>Wireless Mouse</h3>
            <img src="mouse.jpg" alt="Wireless Mouse with ergonomic design" width="200" height="200">
            <p>$29.99</p>
            <p>Ergonomic wireless mouse with 2.4GHz connection.</p>
            <button type="button" aria-label="Add Wireless Mouse to cart">Add to Cart</button>
        </article>

        <article>
            <h3>Mechanical Keyboard</h3>
            <img src="keyboard.jpg" alt="Mechanical keyboard with RGB lighting" width="200" height="200">
            <p>$89.99</p>
            <p>Full-size mechanical keyboard with Cherry MX switches.</p>
            <button type="button" aria-label="Add Mechanical Keyboard to cart">Add to Cart</button>
        </article>
    </section>
</main>
```
