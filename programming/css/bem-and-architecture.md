...
### Example 1: BEM form component

```css
.form { }
.form__group { margin-bottom: 1rem; }
.form__label { display: block; font-weight: 600; margin-bottom: 0.25rem; }
.form__input { width: 100%; padding: 0.5rem 0.75rem; border: 1px solid #ccc; border-radius: 6px; }
.form__input--error { border-color: #dc3545; }
.form__error { color: #dc3545; font-size: 0.875rem; }
.form__actions { display: flex; gap: 0.5rem; justify-content: flex-end; }
```

### Example 2: CSS Modules with React
...
### Example 3: Atomic design with design tokens
